...
import photoBg from "../images/backgroung/mainnn.jpeg";
...
import hPoject1 from "../images/home/hProject1.jpeg";
import hhProject2 from "../images/home/hProject2.jpeg";
import hhProject3 from "../images/home/hProject3.jpeg";
import hhProject4 from "../images/home/hProject4.jpeg";
...
import service1Img from "../images/home/service1.png";
import service2Img from "../images/home/service2.png";
import service3Img from "../images/home/service3.png";
import service4Img from "../images/home/service4.png";
  ...
  return (
    <div className="home">
      <div className="homeNews" style={{ backgroundImage: `url(${photoBg})` }}>
        ...
        <p>
          Dive into the creative world of Interiors wiht us!
          Make ur home colorful!
        </p>
        <Link to="">
          <button>
            Get Started
      ...
      <div className="homeOther">
        <div className="homePlans">
          {services.services
            .filter((services, index) => index < 4)
            .map((s, ind) => {
              const serviceImg = [service1Img, service2Img, service3Img, service4Img][ind];
              return (
                <div className="homePlan" key={ind}>
                  <img src={serviceImg} alt={`Service ${ind + 1}`} />
        ...
        <div className="homeProjects">
          ...
          <div className="hp-list">
            ...
            <div className="hp-project">
              ...
              <div className="hp-pro-detail">
                <div className="hp-pro-info">
                  <p className="hp-prj-title">Modern Study Space</p>
                  <p className="hp-prj-path">Decor / Architecture</p>
                </div>
                <div className="hp-pro-btn">
                  <Link to={`/project-details`}>
            ...
            <div className="hp-project">
              ...
              <div className="hp-pro-detail">
                <div className="hp-pro-info">
                  <p className="hp-prj-title">Modern Dining</p>
                  <p className="hp-prj-path">Decor / Architecture</p>
                </div>
                <div className="hp-pro-btn">
                  <Link to={`/project-details`}>
